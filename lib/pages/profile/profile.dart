import 'package:exercise/pages/profile/cubit/profile_cubit.dart';
...
class ProfileView extends StatelessWidget {
  ...
  ProfileView({required this.myEventData, required this.myChurchesData});

  // final SetName setnameController = Get.put(SetName());
  @override
  Widget build(BuildContext context) {
      ...
      children: [
        ...
        Expanded(
          child: TabBarView(controller: tabController, children: [
            ...
            SingleChildScrollView(
              child: Event(
                itemEvent: myEvents.itemEvent,
                itemEvent2: myEvents.itemEvent2,
              ),
            ),
...
// class SetName extends GetxController {
//   var textname = ''.obs;

//   void updateSetName(String value) {
...
//                       controller: controller,
//                       onChanged: (value) {
//                         setnameController.updateSetName(value);
//                       },
//                       textCapitalization: TextCapitalization.words,
//                     ),
//                     const SizedBox(
...
//                         ElevatedButton(
//                           onPressed: () {
//                             Navigator.of(context).pop(setnameController.textname.value);
//                           },
//                           child: Text('Back'),
//                         ),
//                       ],
...
// //   final MyEventData myEventData;
// //   final MyChurchesData myChurchesData;
// //   final SetName = Get.put(add(String name));
...
// //   const TabBarExample({Key? key, required this.setName, required this.textName})
// //       : super(key: key);
